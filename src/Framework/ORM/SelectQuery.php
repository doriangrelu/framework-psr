...
class SelectQuery extends Query
{
     ...
     * @param $entity
     */
    public function __construct(\PDO $pdo, string $table, array $select, $entity)
    {
     ...
     * @return Query
     */
    private function from(string $table, ?string $alias = null): self
    {
        if ($alias) {
     ...
     * @return Query
     */
    private function select(array $fields): self
    {
        $this->select = $fields;
        return $this;
    }
